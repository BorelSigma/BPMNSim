...
public class File {
	 ...
	 *             </ul>
	 */
	public File(String fileName, int fileSize) throws org.cloudbus.cloudsim.ParameterException {
		if (fileName == null || fileName.length() == 0) {
			throw new org.cloudbus.cloudsim.ParameterException("File(): Error - invalid file name.");
		}

		if (fileSize <= 0) {
			throw new org.cloudbus.cloudsim.ParameterException("File(): Error - size <= 0.");
		}
	 ...
	 */
	public File(org.cloudbus.cloudsim.File file) throws org.cloudbus.cloudsim.ParameterException {
		if (file == null) {
	...
	public org.cloudbus.cloudsim.File makeMasterCopy() {
		org.cloudbus.cloudsim.File file = makeCopy();
		if (file != null) {
	 ...
	 * @return a clone of the current file (as a replica) or <tt>null</tt> if an error occurs
	 */
	private org.cloudbus.cloudsim.File makeCopy() {
		org.cloudbus.cloudsim.File file = null;
		try {
			file = new org.cloudbus.cloudsim.File(name, attribute.getFileSize());
			FileAttribute fileAttr = file.getFileAttribute();
			attribute.copyValue(fileAttr);
			fileAttr.setMasterCopy(false);   // set this file to replica
		} catch (Exception e) {
