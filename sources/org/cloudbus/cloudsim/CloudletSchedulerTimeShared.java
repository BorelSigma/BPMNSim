 ...
 * to run its {@link org.cloudbus.cloudsim.Cloudlet Cloudlets}.
...
public class CloudletSchedulerTimeShared extends CloudletScheduler {
	...
	@Override
	public org.cloudbus.cloudsim.Cloudlet cloudletCancel(int cloudletId) {
		boolean found = false;
		int position = 0;
		...
		if (found) {
			...
			if (rcl.getRemainingCloudletLength() == 0) {
				...
				rcl.setCloudletStatus(org.cloudbus.cloudsim.Cloudlet.CANCELED);
			}
	...
	public boolean cloudletPause(int cloudletId) {
		...
		if (found) {
			...
			if (rcl.getRemainingCloudletLength() == 0) {
				...
				rcl.setCloudletStatus(org.cloudbus.cloudsim.Cloudlet.PAUSED);
	...
	public void cloudletFinish(ResCloudlet rcl) {
		rcl.setCloudletStatus(org.cloudbus.cloudsim.Cloudlet.SUCCESS);
	...
	public double cloudletResume(int cloudletId) {
		...
		if (found) {
			...
			rgl.setCloudletStatus(org.cloudbus.cloudsim.Cloudlet.INEXEC);
	...
	@Override
	public double cloudletSubmit(org.cloudbus.cloudsim.Cloudlet cloudlet, double fileTransferTime) {
		ResCloudlet rcl = new ResCloudlet(cloudlet);
		rcl.setCloudletStatus(org.cloudbus.cloudsim.Cloudlet.INEXEC);
	...
	@Override
	public double cloudletSubmit(org.cloudbus.cloudsim.Cloudlet cloudlet) {
