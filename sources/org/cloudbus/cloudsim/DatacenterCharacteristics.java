...
public class DatacenterCharacteristics {
	...
	private List<? extends org.cloudbus.cloudsim.Host> hostList;
	...
	public DatacenterCharacteristics(
			...
			String os,
			String vmm,
			List<? extends org.cloudbus.cloudsim.Host> hostList,
			double timeZone,
			double costPerSec,
			double costPerMem,
	 ...
	 * @post $none
	 */
	public org.cloudbus.cloudsim.Host getHostWithFreePe(int peNumber) {
	 ...
	 * @post $result >= -1
         ...
         * to a datacenter. Even for the {@link org.cloudbus.cloudsim.Host} it is possible
         * to add Pe's of different capacities through the {@link org.cloudbus.cloudsim.Host#peList} attribute.
	 */
	...
	public int getMips() {
		...
		switch (getAllocationPolicy()) {
                        ...
                        /*@todo But it is possible to add PMs of different configurations
                            ...
                            of a Datacenter*/
			case org.cloudbus.cloudsim.DatacenterCharacteristics.TIME_SHARED:
			case org.cloudbus.cloudsim.DatacenterCharacteristics.OTHER_POLICY_SAME_RATING:
			...
			case org.cloudbus.cloudsim.DatacenterCharacteristics.SPACE_SHARED:
			case org.cloudbus.cloudsim.DatacenterCharacteristics.OTHER_POLICY_DIFFERENT_RATING:
				for (org.cloudbus.cloudsim.Host host : getHostList()) {
	...
	public <T extends org.cloudbus.cloudsim.Host> List<T> getHostList() {
