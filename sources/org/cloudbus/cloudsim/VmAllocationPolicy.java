...
public abstract class VmAllocationPolicy {
	 ...
	 * @post $none
	 */
	public VmAllocationPolicy(List<? extends org.cloudbus.cloudsim.Host> list) {
		setHostList(list);
	}
	 ...
	 * @post $none
	 */
	public abstract boolean allocateHostForVm(Vm vm, org.cloudbus.cloudsim.Host host);
	 ...
	 * @post $none
	 */
	public abstract org.cloudbus.cloudsim.Host getHost(Vm vm);
	 ...
	 * @post $none
	 */
	public abstract org.cloudbus.cloudsim.Host getHost(int vmId, int userId);
	 ...
	 */
	protected void setHostList(List<? extends org.cloudbus.cloudsim.Host> hostList) {
