...
public abstract class VmScheduler {
	 ...
	 * @post $none
	 */
	public abstract boolean allocatePesForVm(org.cloudbus.cloudsim.Vm vm, List<Double> mipsShare);
	 ...
	 * @post $none
	 */
	public abstract void deallocatePesForVm(org.cloudbus.cloudsim.Vm vm);
	 ...
	 */
	public List<Pe> getPesAllocatedForVM(org.cloudbus.cloudsim.Vm vm) {
	 ...
	 * @post $none
	 */
	public List<Double> getAllocatedMipsForVm(org.cloudbus.cloudsim.Vm vm) {
