 ...
 * @see SimEntity
 */
public class SimEvent implements Cloneable, Comparable<org.cloudbus.cloudsim.core.SimEvent> {
	...
	@Override
	public int compareTo(org.cloudbus.cloudsim.core.SimEvent event) {
		if (event == null) {
			return 1;
	...
	@Override
	public Object clone() {
		return new org.cloudbus.cloudsim.core.SimEvent(etype, time, entSrc, entDst, tag, data);
	}
