...
public class FutureQueue {
	...
	private final SortedSet<org.cloudbus.cloudsim.core.SimEvent> sortedSet = new TreeSet<org.cloudbus.cloudsim.core.SimEvent>();

	/** A incremental number used for {@link org.cloudbus.cloudsim.core.SimEvent#serial} event attribute.
         */
	 ...
	 */
	public void addEvent(org.cloudbus.cloudsim.core.SimEvent newEvent) {
	 ...
	 * @param newEvent The event to be put in the queue.
	 */
	public void addEventFirst(org.cloudbus.cloudsim.core.SimEvent newEvent) {
	 ...
	 * @return the iterator
	 */
	public Iterator<org.cloudbus.cloudsim.core.SimEvent> iterator() {
	 ...
	 */
	public boolean remove(org.cloudbus.cloudsim.core.SimEvent event) {
