...
public class FileAttribute {
	 ...
	 *             </ul>
	 */
	public FileAttribute(String fileName, int fileSize) throws org.cloudbus.cloudsim.ParameterException {
		// check for errors in the input
		if (fileName == null || fileName.length() == 0) {
			throw new org.cloudbus.cloudsim.ParameterException("FileAttribute(): Error - invalid file name.");
		}
	 ...
	 */
	public boolean copyValue(org.cloudbus.cloudsim.FileAttribute attr) {
		if (attr == null) {
			return false;
		}
