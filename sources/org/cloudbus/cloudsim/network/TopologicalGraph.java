...
public class TopologicalGraph {
	...
	private List<TopologicalLink> linkList = null;
         ...
         */
	private List<org.cloudbus.cloudsim.network.TopologicalNode> nodeList = null;
	...
	public TopologicalGraph() {
		...
		nodeList = new LinkedList<org.cloudbus.cloudsim.network.TopologicalNode>();
	}
	 ...
	 */
	public void addNode(org.cloudbus.cloudsim.network.TopologicalNode node) {
		nodeList.add(node);
	}
	 ...
	 */
	public Iterator<org.cloudbus.cloudsim.network.TopologicalNode> getNodeIterator() {
