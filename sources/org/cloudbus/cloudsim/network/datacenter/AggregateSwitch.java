 ...
 */
public class AggregateSwitch extends org.cloudbus.cloudsim.network.datacenter.Switch {
	...
	public AggregateSwitch(String name, int level, NetworkDatacenter dc) {
		...
		uplinkswitches = new ArrayList<org.cloudbus.cloudsim.network.datacenter.Switch>();
		downlinkswitches = new ArrayList<org.cloudbus.cloudsim.network.datacenter.Switch>();
	}
