...
public class NetworkDatacenter extends Datacenter {
	...
	public Map<Integer, Integer> HostToSwitchid;
         ...
         */
	public Map<Integer, org.cloudbus.cloudsim.network.datacenter.Switch> Switchlist;
	...
	public NetworkDatacenter(
		...
		Switchlist = new HashMap<Integer, org.cloudbus.cloudsim.network.datacenter.Switch>();
	}
	 ...
	 */
	public Map<Integer, org.cloudbus.cloudsim.network.datacenter.Switch> getEdgeSwitch() {
		Map<Integer, org.cloudbus.cloudsim.network.datacenter.Switch> edgeswitch = new HashMap<Integer, org.cloudbus.cloudsim.network.datacenter.Switch>();
