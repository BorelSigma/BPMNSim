...
public class WorkflowApp extends AppCloudlet {
	...
	public void createCloudletList(List<Integer> vmIdList) {
		...
		cl.stages.add(new org.cloudbus.cloudsim.network.datacenter.TaskStage(NetworkConstants.EXECUTION, 0, 1000 * 0.8, 0, memory, vmIdList.get(0), cl
				.getCloudletId()));
		cl.stages.add(new org.cloudbus.cloudsim.network.datacenter.TaskStage(NetworkConstants.WAIT_SEND, 1000, 0, 1, memory, vmIdList.get(2), cl
				.getCloudletId() + 2));
		clist.add(cl);
		i++;
		// Task B
		...
		clb.stages.add(new org.cloudbus.cloudsim.network.datacenter.TaskStage(
				...
				vmIdList.get(1),
				clb.getCloudletId()));
		clb.stages.add(new org.cloudbus.cloudsim.network.datacenter.TaskStage(NetworkConstants.WAIT_SEND, 1000, 0, 1, memory, vmIdList.get(2), clb
				.getCloudletId() + 1));
		clist.add(clb);
		i++;
		...
		// first stage: big computation
		clc.stages.add(new org.cloudbus.cloudsim.network.datacenter.TaskStage(NetworkConstants.WAIT_RECV, 1000, 0, 0, memory, vmIdList.get(0), cl
				.getCloudletId()));
		clc.stages.add(new org.cloudbus.cloudsim.network.datacenter.TaskStage(NetworkConstants.WAIT_RECV, 1000, 0, 1, memory, vmIdList.get(1), cl
				.getCloudletId() + 1));
