...
public class Cloudlet {
     ...
     * execution history on each VM is registered at {@link org.cloudbus.cloudsim.Cloudlet#resList}
     */
    ...
    public void setCloudletStatus(final int newStatus) throws Exception {
        ...
        if (newStatus < org.cloudbus.cloudsim.Cloudlet.CREATED || newStatus > org.cloudbus.cloudsim.Cloudlet.FAILED_RESOURCE_UNAVAILABLE) {
            throw new Exception(
                    "Cloudlet.setCloudletStatus() : Error - Invalid integer range for Cloudlet status.");
        }

        if (newStatus == org.cloudbus.cloudsim.Cloudlet.SUCCESS) {
            finishTime = CloudSim.clock();
        }

        if (record) {
            write("Sets Cloudlet status from " + getCloudletStatusString() + " to "
                    + org.cloudbus.cloudsim.Cloudlet.getStatusString(newStatus));
        }
    ...
    public String getCloudletStatusString() {
        return org.cloudbus.cloudsim.Cloudlet.getStatusString(status);
    }
    ...
    public static String getStatusString(final int status) {
        ...
        switch (status) {
            case org.cloudbus.cloudsim.Cloudlet.CREATED:
                statusString = "Created";
                break;

            case org.cloudbus.cloudsim.Cloudlet.READY:
                statusString = "Ready";
                break;

            case org.cloudbus.cloudsim.Cloudlet.INEXEC:
                statusString = "InExec";
                break;

            case org.cloudbus.cloudsim.Cloudlet.SUCCESS:
                statusString = "Success";
                break;

            case org.cloudbus.cloudsim.Cloudlet.QUEUED:
                statusString = "Queued";
                break;

            case org.cloudbus.cloudsim.Cloudlet.FAILED:
                statusString = "Failed";
                break;

            case org.cloudbus.cloudsim.Cloudlet.CANCELED:
                statusString = "Canceled";
                break;

            case org.cloudbus.cloudsim.Cloudlet.PAUSED:
                statusString = "Paused";
                break;

            case org.cloudbus.cloudsim.Cloudlet.RESUMED:
                statusString = "Resumed";
                break;

            case org.cloudbus.cloudsim.Cloudlet.FAILED_RESOURCE_UNAVAILABLE:
